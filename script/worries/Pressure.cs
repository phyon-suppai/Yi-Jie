...
/// <summary>压：过载，拖着任务箱缓慢移动。随时间成长：HP 无上限增长，精灵按 log(HP) 放大。</summary>
public partial class Pressure : Area2D
{
	[ExportGroup("成长")]
	/// <summary>初始生命值（可调）</summary>
	[Export] public float InitialHp { get; set; } = 15f;

	/// <summary>生命值随时间增长的速度（HP/秒，无上限）</summary>
	[Export] public float HpGrowPerSec { get; set; } = 1.5f;
